                ...
                {% if prog.link %}
                  {% if prog.isrecorded %}
                    {% if prog.hasslides %}
                          ...
                          {% else %}
                            <td><a href="{{ prog.link | prepend: site.relative_url }}" style="color: #0073ee;"> {{currentcount}}{{ prog.title }} </a> (<a href="{{ prog.recording }}" style="color: #0073ee;">Session Recording</a>, <a href="{{ prog.slides | prepend: site.relative_url }}" style="color: #0073ee;">Slides</a>) </td> 
                          {% endif %}
                        {% else %}
